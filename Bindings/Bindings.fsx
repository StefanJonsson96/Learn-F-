let letBindings _ = // Bindings are anything that is assigned using let keyword
    ...
    printfn "%A" mutableString // even though this works, its not common to use mutable bindings in f#
    0
